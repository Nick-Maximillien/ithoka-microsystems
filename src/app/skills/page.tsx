...
export default function SkillsPage() {
  return (
    <section className="skillsPag">
      <div className="her">
        <h1 className="skillTitle">Tools powering our work</h1>
        <p className="skillSubtitle">Core technologies and practices powering Ithoka Microsystems — AI, Blockchain, Fullstack engineering, and innovation.</p>
      </div>
