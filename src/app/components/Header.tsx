  ...
  return (
    <header className="header" style={{ position: 'sticky', top: 0, zIndex: 1000 }}>
      <div className="row headerContainer">
        <div className="head">
          {/* Logo */}
          <div className="logo" style={{ borderRadius: '10px' }}>
            <Image
              className="logoImg"
              src="/images/log.jpg"
              alt="logo"
                ...
                {mounted && dropDownOpen &&
                  createPortal(
                    ...
                    >
                      ...
                      <li className="menuItem"><Link href="/projects">Client and R&D Projects</Link></li>
                      <li className="menuItem"><Link href="/skills">Expertise</Link></li>
